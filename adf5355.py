...
class adf5355(object):
    ...
    def __init__(self, spi, ref_div_factor=0, ref_doubler_en=False, ref_div2_en=False, cp_curr_uA=900,
                 ...
                 phase_detector_polarity_neg=False, clkin=25000000, cp_gated_bleed_en=False, cp_neg_bleed_en=True,
    ...
    def setup(self):
        ...
        while True:
            ...
            self.st.fpfd = int((self.st.clkin * (2 if self.ref_doubler_en else 1)) / (
    ...
    def set_freq(self, freq, channel):
        ...
        """
             ...
             */
        """
        self.cp_bleed = DIV_ROUND_UP(400 * self.cp_curr_uA, self.st.integer * 375)
        self.cp_bleed = clamp(self.cp_bleed, 1, 255)
    ...
    def set_mtl(self, mtl):
        self.mute_till_lock_detect_en=mtl;
        return self.sync_config(False)
